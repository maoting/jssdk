...
const { exit } = require('@bjh/cli-shared-utils/lib/exit')
const { error } = require('@bjh/cli-shared-utils/lib/logger')
const { createSchema, validate } = require('@bjh/cli-shared-utils/lib/validate')
